...
import { Heart, ShoppingCart, Zap, LogIn, LogOut, Phone, Mail, User } from "lucide-react";
...
export function MobileMenu({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-2 py-4 border-b border-slate-200 dark:border-slate-700">
            ...
            <div className="space-y-3">
              <SheetClose asChild>
                <Button
                  onClick={onLogout}
                  variant="outline"
                  className="w-full bg-transparent border-slate-200 dark:border-slate-700 text-destructive hover:text-destructive"
                >
