...
export function FeaturedProducts() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-12 bg-gradient-to-b from-muted/10 to-background relative overflow-hidden">
      <div className="absolute inset-0 chip-pattern opacity-10 sm:opacity-15 md:opacity-20" />
      <div className="absolute inset-0 bg-gradient-to-r from-primary/5 via-transparent to-accent/5" />

      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute top-10 sm:top-16 left-6 sm:left-10 text-primary/10"
        ...
        <motion.div
          className="absolute bottom-10 sm:bottom-16 right-6 sm:right-10 text-accent/10"
          animate={{ y: [0, 15, 0], x: [0, -8, 0] }}
          transition={{ duration: 6, repeat: Number.POSITIVE_INFINITY }}
        >
          <Microchip className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
            Featured Components
          </h2>
          <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl sm:max-w-3xl mx-auto leading-relaxed">
          ...
          {getCurrentProducts().map((product, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <Card className="iot-card border-primary/20 bg-card/80 backdrop-blur-sm overflow-hidden h-full flex flex-col">
                  <div className="relative overflow-hidden">
                    <div className="relative overflow-hidden bg-gradient-to-br from-muted/20 to-muted/10 h-40 sm:h-44 md:h-48">
                      <img
                        src={
                          product.images[0] ||
                      ...
                      <div className="absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500">
                        <Cpu className="absolute top-2 sm:top-3 right-2 sm:right-3 w-4 sm:w-5 h-4 sm:h-5 text-primary animate-chip-glow" />
                        <Wifi className="absolute bottom-2 sm:bottom-3 left-2 sm:left-3 w-3 sm:w-4 h-3 sm:h-4 text-accent animate-sensor-wave" />
                        <Database className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-5 sm:w-6 h-5 sm:h-6 text-primary/60 animate-floating-up" />
                      </div>
                    </div>

                    <div className="absolute top-2 sm:top-3 left-2 sm:left-3">
                      {product.inStock ? (
                        <Badge className="bg-primary text-primary-foreground text-xs sm:text-sm electronics-glow animate-micro-bounce">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className={`absolute top-2 sm:top-3 right-2 sm:right-3 transition-all duration-300 hover:bg-background/80 ${
                  ...
                  <CardContent className="p-3 sm:p-4 flex-1">
                    <div className="mb-2 sm:mb-3">
                      <Link
                        href="/"
                        className="font-semibold text-sm sm:text-base hover:text-primary transition-colors line-clamp-2 leading-tight"
                      >
                        {product.name}
                      </Link>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <Microchip className="h-3 w-3 sm:h-4 sm:w-4 text-primary animate-arduino-blink" />
                  ...
                  <CardFooter className="p-3 sm:p-4 pt-0 flex gap-2 sm:gap-3">
                    <Button
                      size="sm"
                      className="flex-1 group bg-primary hover:bg-primary/90 text-xs sm:text-sm electronics-glow cursor-pointer"
                      onClick={() => handleAddToCart(product)}
                      disabled={!product.inStock}
                    >
                      <ShoppingCart className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2 group-hover:scale-110 transition-transform" />
                      Add to Cart
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                      asChild
                      className="hover:border-primary hover:text-primary bg-transparent px-2 sm:px-3 text-xs sm:text-sm"
                    >
                      <Link href="/">
        ...
        <div className="flex items-center justify-center mt-10 sm:mt-12 md:mt-16 space-x-6 sm:space-x-8">
          <Button
            variant="outline"
            size="icon"
            onClick={prevPage}
            className="hover:border-primary hover:text-primary hover:bg-primary/10 bg-transparent transition-all duration-300 hover:scale-110 electronics-glow w-8 h-8 sm:w-10 sm:h-10"
          >
        ...
        <div className="text-center mt-10 sm:mt-12 md:mt-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Button
              size="lg"
              asChild
              className="hover:scale-105 transition-transform bg-primary hover:bg-primary/90 electronics-glow text-sm sm:text-base md:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto"
            >
              <Link href="/">
                <Cpu className="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2 animate-chip-glow" />
                View All Products
              </Link>
            </Button>
          </motion.div>
